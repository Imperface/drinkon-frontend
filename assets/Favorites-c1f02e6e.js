import{s as c,d,R as h,u as y,b as j,j as i,c as v,r as u,g as $,S as z,e as E}from"./index-5517f1fc.js";import{P as S}from"./PageTitle-bfda1da7.js";const M=c.div`
  width: 100%;
...
`,K=c(Z)`
  fill: ${e=>e.theme.colors.whiteThirtyColor};
`,A=({itemsPerPage:e,totalItems:t})=>{const n=y(),r=j(C),o=Math.ceil(t/e),a=s=>{n(v(s))},p=()=>{const s=[];s.push(i.jsx(m,{children:i.jsx(b,{onClick:()=>a(r-1),disabled:r===1,children:i.jsx(G,{})})},"prev"));for(let l=1;l<=o;l++)s.push(i.jsx(m,{children:i.jsxs(b,{onClick:()=>a(l),children:[i.jsx(W,{active:r===l?"true":"false"}),i.jsx("span",{children:l})]})},l));return s.push(i.jsx(m,{children:i.jsx(b,{onClick:()=>a(r+1),disabled:r===o,children:i.jsx(K,{})})},"next")),s};return i.jsx("nav",{"aria-label":"Page navigation",children:i.jsx(_,{children:p()})})};function q(e){return x({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"},child:[]}]})(e)}const J=c.li`
  display: flex;
...
`;function ae({data:e,onRemoveDrinks:t}){const[n,r]=u.useState(9);u.useEffect(()=>{const s=()=>{window.innerWidth<=768?r(8):r(9)};return window.addEventListener("resize",s),s(),()=>{window.removeEventListener("resize",s)}},[]);const{currentPage:o,currentData:a,handlePageChange:p}=ie(e,n);return i.jsxs(i.Fragment,{children:[i.jsx(oe,{children:a.map(s=>i.jsx(re,{...s,onRemoveDrinks:t},s._id))}),e.length>n&&i.jsx(A,{currentPage:o,itemsPerPage:n,totalItems:e.length,onPageChange:p})]})}const se=e=>e.drinks.favorites,pe=()=>{const e=j(se),t=y();u.useEffect(()=>{t($())},[t]);const n=r=>{console.log(r),t(E(r))};return i.jsx(M,{children:i.jsxs(z,{className:"favorites",children:[i.jsx(S,{name:"Favorites"}),i.jsx(ae,{data:e,onRemoveDrinks:n})]})})};export{pe as default};
