...
`,_=c(L)`
  fill: ${e=>e.theme.colors.whiteThirtyColor};
`,R=({itemsPerPage:e,totalItems:t})=>{const n=j(),r=P(C),o=Math.ceil(t/e),a=s=>{n(b(s))},h=()=>{const s=[];s.push(i.jsx(x,{children:i.jsx(m,{onClick:()=>a(r-1),disabled:r===1,children:i.jsx(Z,{})})},"prev"));for(let l=1;l<=o;l++)s.push(i.jsx(x,{children:i.jsxs(m,{onClick:()=>a(l),children:[i.jsx(T,{active:r===l?"true":"false"}),i.jsx("span",{children:l})]})},l));return s.push(i.jsx(x,{children:i.jsx(m,{onClick:()=>a(r+1),disabled:r===o,children:i.jsx(_,{})})},"next")),s};return i.jsx("nav",{"aria-label":"Page navigation",children:i.jsx(N,{children:h()})})};function F(e){return u({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"},child:[]}]})(e)}const W=c.li`
  display: flex;
